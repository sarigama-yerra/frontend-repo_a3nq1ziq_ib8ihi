      ...
      >
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-24 w-[70%] h-44 border border-zinc-700/70 bg-black/60 rounded-xl flex items-center justify-center">
          <div className="text-center">
            <div className="tracking-[0.4em] text-xs text-[#D4AF37]">ELANOR</div>
            <div className="mt-2 text-4xl md:text-5xl font-serif tracking-[0.12em] text-white">WRATH</div>
...
export default function ProductHero() {
  ...
  return (
    <section className="relative bg-black text-white px-4 md:px-8 lg:px-12 pt-10 md:pt-20 pb-14">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 md:gap-14 items-start">
        ...
        <div className="md:col-span-2 order-1 md:order-2">
          <div className="space-y-5">
            <div>
              <h1 className="text-5xl md:text-6xl font-serif tracking-[0.08em]">WRATH</h1>
